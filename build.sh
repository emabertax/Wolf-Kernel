...
message "Starting kernel compilation"
rm -rf out
...
then
    ...
    message @AliHasan7671 build completed %0AMD5sum - $md5 %0ASize - $size %0A"[Gdrive link](https://drive.google.com/uc?id=$fileid&export=download)"
